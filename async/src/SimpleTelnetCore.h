 ...
 * Canonical source: SimpleTelnet repo, src/SimpleTelnetCore.h.
 * Keep this file byte-for-byte in sync with upstream (this is a prototype
 * location; in the final split this lives in the AsyncSimpleTelnet repo).
 *
